...
select billing_country, count(billing_country) as Countries 
from invoice
...
limit 3;
 ...
 -- we made the most money. Write a query that return one city that has the highest sum of invoice totoals.
...
order by invoice_total desc;
 ...
 -- Write a query thats return the person who has spend the most money?
